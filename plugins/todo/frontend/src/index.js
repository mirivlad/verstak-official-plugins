...
(function () {
  ...
  var STYLES = [
    ...
    '.todo-filters{display:flex;align-items:center;gap:.35rem;min-width:0;flex:1;flex-wrap:nowrap}',
    ...
    '@container(max-width:980px){.todo-filters{order:10;flex:1 0 100%;width:100%}.todo-input.search{flex:1;min-width:0;width:auto}}',
    '@media(max-width:820px){.todo-toolbar{align-items:stretch}.todo-row{grid-template-columns:1fr}.todo-row-actions{justify-content:flex-start}.todo-form-grid{grid-template-columns:1fr}.todo-field.wide{grid-column:auto}}'
  ].join('\n');
